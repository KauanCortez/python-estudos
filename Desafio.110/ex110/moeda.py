...
def resumo(valor=0, aumento=10, reduzir=5):
    """
    -> Utiliza todas as funções criadas para mostrar informações sobre o valor informado.
    :param: valor: Valor cujo as informações serão mostradas.
    :param: aumento: Taxa (%), em porcentagem, que será acrescentada ao valor
    :param: reduzidr: Taxa (%), em porcentagem, que será retirada do valor.'
    """
    print('-' * 34)
    ...
    print(f'{reduzir}% de redução: \t{diminuir(valor, reduzir, True)} ')  
    print('-' * 34)      
